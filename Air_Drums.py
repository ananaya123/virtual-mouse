...
mixer.init()
drum_clap = mixer.Sound('Virtual_Drum/batterrm.wav')
drum_snare = mixer.Sound('Virtual_Drum/button-2.ogg')
...
Hatt = cv2.resize(cv2.imread('Virtual_Drum\Images/Hatt.png'),(200,100),interpolation=cv2.INTER_CUBIC)
Snare = cv2.resize(cv2.imread('Virtual_Drum\Images/Snare.png'),(200,100),interpolation=cv2.INTER_CUBIC)
...
while True:
	...
	cv2.putText(frame,'Virtual_Drum',(10,30),2,1,(20,20,20),2)
